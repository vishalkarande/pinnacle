					...
					<div class="col-md-12">
						<div class="mu-book-overview-area">
							...
							<div class="mu-heading-area">
								<h2 class="mu-heading-title">Non-Technical Books</h2>
							...
							<div class="mu-book-overview-content">
								<div class="row">
										<?php
												...
												$ret=mysqli_query($con,"select books.name as pname,books.author as pauthor,books.discription as pdis from books left join books_category on books.cat_id=books_category.id where books_category.id= 2");
									...
									<div class="col-md-3 col-sm-6">
										<div class="mu-book-overview-single">
											...
											<?php	echo htmlentities($row['pauthor']);
												
												
												?>
											</p>
											<p><?php	echo htmlentities($row['pdis']); ?></p>
										</div>
									</div>
									<!-- / Book Overview Single Content -->
