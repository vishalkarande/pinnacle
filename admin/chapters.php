...
if(!empty($_POST['user_action'])) {
  switch($_POST['user_action']) {
       case 'add':
           ...
           if(empty($data)) {
             $QueryFire->insertData("chapter",array('name'=>trim(strip_tags($_POST['name'])),'domain-id'=>trim(strip_tags($_POST[''])),'author_id'=>trim(strip_tags($_POST['name'])),'file_upload'=>trim(strip_tags($_POST['name']))));
...
$chapters = $QueryFire->getAllData('chapter','is_deleted=0 ','SELECT ch.* ,d.name as dname, a.name as author FROM chapter as ch  LEFT JOIN domain as d ON d.id=ch. domain_id  LEFT JOIN author as a on a.id=ch.a_id WHERE ch.is_deleted=0');
...
?>
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Manage chapters  <button class="btn btn-primary dev-add">Add chapters </button></h1>
        </div>
        <div class="col-sm-6">
          ...
          <div class="modal-body">
               <div class="form-group">
                  ...
                  <label for="author"> Author</label>
                    <select class="form-control category" name="author">
                  ...
                  <input class="form-control category" name="fileupload" required placeholder="Enter File Name" type="file"
               </div>
    ...
    $(document).ready(function() {
      ...
      jQuery(document).on("click",".dev-delete",function(e){
          if(jQuery(this).data("id") != "") {
              ...
              bootbox.confirm({
                  title: "Are you sure you want to delete this chapters?",
