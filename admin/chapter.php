         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <label for="a-id">Author:</label>
                  <input class="form-control category" name="a_id" required placeholder="Enter chapter Name" type="text">
                  <label for="domain">Domain:</label>
                  <input class="form-control category" name="doamin" required placeholder="Enter chapter Name" type="text">
               </div>
